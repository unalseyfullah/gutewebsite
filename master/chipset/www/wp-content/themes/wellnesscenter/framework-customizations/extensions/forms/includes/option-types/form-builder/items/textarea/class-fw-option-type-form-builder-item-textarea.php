...
class Wellnesscenter_Option_Type_Form_Builder_Item_Textarea extends FW_Option_Type_Form_Builder_Item {
	...
	public function get_thumbnails() {
		return array(
			array(
				'html' =>
					'<div class="item-type-icon-title" data-hover-tip="' . __( 'Add a Paragraph Text', 'wellnesscenter' ) . '">' .
					'<div class="item-type-icon"><img src="' . esc_url( $this->get_uri( '/static/images/icon.png' ) ) . '" /></div>' .
					'<div class="item-type-title">' . __( 'Paragraph Text', 'wellnesscenter' ) . '</div>' .
					'</div>'
			)
		);
	}
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			...
			array(
				...
				'l10n'     => array(
					'item_title'      => __( 'Paragraph Text', 'wellnesscenter' ),
					...
					'options' => array(
						array(
							'label' => array(
								...
								'value' => __( 'Paragraph Text', 'wellnesscenter' ),
							)
						),
						array(
							'required' => array(
...
FW_Option_Type_Builder::register_item_type( 'Wellnesscenter_Option_Type_Form_Builder_Item_Textarea' );