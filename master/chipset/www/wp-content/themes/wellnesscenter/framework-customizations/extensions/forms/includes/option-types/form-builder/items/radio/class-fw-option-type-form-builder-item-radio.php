...
class Wellnesscenter_Option_Type_Form_Builder_Item_Radio extends FW_Option_Type_Form_Builder_Item {
		...
		return array(
			array(
				'html' =>
					...
					'</div>' .
					'<div class="item-type-title">' . __( 'Single Choice', 'wellnesscenter' ) . '</div>' .
					'</div>'
			)
		);
	}
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			...
			array(
				'l10n'     => array(
					'item_title'      => __( 'Single Choice', 'wellnesscenter' ),
					...
					'options' => array(
						array(
							'label' => array(
								...
								'value' => __( 'Single Choice', 'wellnesscenter' ),
							)
						),
						array(
							'required' => array(
	...
	protected function get_fixed_attributes( $attributes ) {
		...
		if ( empty( $attributes['options']['choices'] ) ) {
			$attributes['options']['choices'][] = __( 'Single Choice', 'wellnesscenter' );
		}
...
FW_Option_Type_Builder::register_item_type( 'Wellnesscenter_Option_Type_Form_Builder_Item_Radio' );
