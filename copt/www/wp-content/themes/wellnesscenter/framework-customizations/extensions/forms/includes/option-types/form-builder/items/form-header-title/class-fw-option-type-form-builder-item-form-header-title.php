...
class Wellnesscenter_Option_Type_Form_Builder_Item_Form_Header_Title extends FW_Option_Type_Form_Builder_Item {
	...
	public function enqueue_static() {
		...
		wp_localize_script(
			...
			array(
				'l10n'     => array(
					'edit_title'    => __( 'Edit Title', 'wellnesscenter' ),
					'edit_subtitle' => __( 'Edit Subtitle', 'wellnesscenter' ),
				),
	...
	private function get_options() {
		return array(
			'title'    => array(
				...
				'desc'  => __( 'The title will be displayed on contact form header', 'wellnesscenter' ),
				'value' => '',
			),
			'subtitle' => array(
				'type'  => 'textarea',
				'label' => __( 'Subtitle', 'wellnesscenter' ),
				'desc'  => __( 'The form header subtitle text', 'wellnesscenter' ),
				'value' => '',
			)
		);
	}
...
FW_Option_Type_Builder::register_item_type( 'Wellnesscenter_Option_Type_Form_Builder_Item_Form_Header_Title' );
