...
<div class="fw-alert fw-alert-<?php echo esc_attr( $atts['type'] ); ?>">
	...
	switch ( $atts['type'] ) {
		case 'success' :
			...
			echo '<strong>' . __( 'Congratulations!', 'wellnesscenter' ) . '</strong> ';
			break;
		case 'info' :
			echo '<i class="fa fa-exclamation-circle alert-icon"></i>';
			echo '<strong>' . __( 'Information!', 'wellnesscenter' ) . '</strong> ';
			break;
		case 'warning' :
			echo '<i class="fa fa-warning alert-icon"></i>';
			echo '<strong>' . __( 'Alert!', 'wellnesscenter' ) . '</strong> ';
			break;
		case 'danger' :
			echo '<i class="fa fa-times-circle alert-icon"></i>';
			echo '<strong>' . __( 'Error!', 'wellnesscenter' ) . '</strong> ';
			break;
	}
