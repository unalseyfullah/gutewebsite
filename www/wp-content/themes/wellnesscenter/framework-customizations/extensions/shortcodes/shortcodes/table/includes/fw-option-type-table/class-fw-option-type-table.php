...
class Wellnesscenter_Option_Type_Table extends FW_Option_Type
{
	...
	protected function _render( $id, $option, $data ) {
		...
		if ( ! $table_shortcode ) {
			trigger_error(
				__( 'table-builder option type must be inside the table shortcode', 'wellnesscenter' ),
				E_USER_ERROR
			);
		}
	...
	protected function _get_defaults() {
		return array(
			'header_options'  => array(
				'table_purpose' => array(
					'type'    => 'select',
					'label'   => __( 'Table Styling', 'wellnesscenter' ),
					'desc'    => __( 'Choose the table styling options', 'wellnesscenter' ),
					'choices' => array(
						'pricing' => __( 'Use the table as a pricing table', 'wellnesscenter' ),
						'tabular' => __( 'Use the table to display tabular data', 'wellnesscenter' ),
					),
					'value'   => 'pricing',
					'attr'    => array(
			...
			'row_options'     => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-row' => __( 'Default row', 'wellnesscenter' ),
						'heading-row' => __( 'Heading row', 'wellnesscenter' ),
						'pricing-row' => __( 'Pricing row', 'wellnesscenter' ),
						'button-row'  => __( 'Button row', 'wellnesscenter' ),
						'switch-row'  => __( 'Modal button row', 'wellnesscenter' )
					),
				)
			),
			'columns_options' => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-col'   => __( 'Default column', 'wellnesscenter' ),
						'highlight-col' => __( 'Highlight column', 'wellnesscenter' ),
					),
				)
			),
			'content_options' => array(
				...
				'switch-row' => array(
					'button_text' => array(
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => __('button text', 'wellnesscenter')
						),
					),
				),
				'heading-row' => array(
					'heading' => array(
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => __('title', 'wellnesscenter')
						),
					),
					'sub_heading' => array(
						'type'  => 'text',
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => __('sub title (can be left blank)', 'wellnesscenter')
						),
					),
				),
				'pricing-row' => array(
					'amount' => array(
						...
						'value' => '',
						'attr' => array(
							'placeholder' => __('199', 'wellnesscenter')
						),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-12'
						)
					...
					'description' => array(
						...
						'value'        => '',
						'attr' => array(
							'placeholder' => __('per day', 'wellnesscenter')
						),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-6'
						)
				...
				'button-row'  => array(
					'button' => ($button = fw()->extensions->get( 'shortcodes' )->get_shortcode( 'button' ))
						? array(
							'type'          => 'popup',
							'popup-title'   => __( 'Button', 'wellnesscenter' ),
							'button'        => __( 'Add', 'wellnesscenter' ),
